...
//Animate Presence will call the exit animation if the element is removed from the DOM. using this we can simply remove elements and let Motion handle timing
// in react-spring/css we'd need to handle timing ourselves before safely removing an element
